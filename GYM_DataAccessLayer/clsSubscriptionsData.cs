...
namespace GYM_DataAccessLayer
{
    public class clsSubscriptionsData
    {
        ...
        public static bool GetSubscriptionInfoByID(int SubscriptionID, ref int MemberID, ref int CreateByUserID, ref int SubscriptionTypeID, ref DateTime StartDate, ref DateTime EndDate, ref string Status)
        {
            bool found = false;
            try
            {
