...
namespace GYM_MS
{
    public partial class frmAddUpdateMember : Form
    {
        ...
        {
            clsSubscriptionTypes SubscriptionType = clsSubscriptionTypes.Find(cmbSubscriptionType.Text);
            ...
            lblDurationDays.Text = SubscriptionType.DurationDays.ToString();
            lblSubscriptionPrice.Text = SubscriptionType.Price.ToString();
